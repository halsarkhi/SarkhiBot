...
export const WORKER_TYPES = {
  ...
  system: {
    label: 'System Worker',
    emoji: '🖥️',
    categories: ['core', 'process', 'monitor', 'network', 'utility', 'devtools'],
    description: 'OS operations, monitoring, network, dev tools',
  ...
  research: {
    ...
    emoji: '🔍',
    categories: ['browser', 'core', 'weather', 'translate', 'crypto'],
  ...
  data: {
    label: 'Data Worker',
    emoji: '📊',
    categories: ['core', 'data', 'utility'],
    description: 'Data analysis, text processing, JSON/regex operations',
    timeout: 300,    // 5 minutes
  },
  creative: {
    label: 'Creative Worker',
    emoji: '🎨',
    categories: ['core', 'browser', 'translate'],
    description: 'Creative content generation, writing, translation',
    timeout: 600,    // 10 minutes
  },
  social: {
    label: 'Social Worker',
