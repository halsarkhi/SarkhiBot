...
const SCREENSHOTS_DIR = join(homedir(), '.sarkhibot', 'screenshots');
  ...
  },
  {
    ...
    input_schema: {
      ...
      properties: {
        file_path: {
          type: 'string',
          description: 'Absolute path to the image file to send (e.g., "/home/user/.sarkhibot/screenshots/example.png")',
        },
        caption: {
          type: 'string',
