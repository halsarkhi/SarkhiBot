...
export const TOOL_CATEGORIES = {
  ...
  translate: ['translate_text', 'detect_language'],
  crypto: ['crypto_price', 'crypto_top'],
  utility: ['calculate', 'unit_convert', 'base_convert', 'hash_text', 'encode_decode', 'generate_random', 'current_time', 'time_diff', 'timestamp_convert', 'world_clocks', 'cron_explain', 'cron_build'],
  data: ['json_format', 'json_query', 'json_diff', 'regex_test', 'regex_replace', 'regex_extract', 'text_stats', 'text_transform', 'text_diff'],
  devtools: ['http_request', 'api_health_check', 'dns_lookup', 'reverse_dns', 'whois_lookup', 'archive_create', 'archive_extract', 'archive_list'],
};
...
const CATEGORY_KEYWORDS = {
  ...
  translate: ['translate', 'translation', 'language', 'localize', 'arabic', 'french', 'spanish', 'german'],
  crypto: ['crypto', 'bitcoin', 'ethereum', 'blockchain', 'coin', 'token price', 'market cap'],
  utility: ['calculate', 'convert', 'hash', 'encode', 'decode', 'base64', 'uuid', 'password', 'random', 'time', 'timezone', 'cron', 'schedule'],
  data: ['json', 'regex', 'format', 'parse', 'validate', 'diff', 'compare', 'word count', 'text analysis', 'camelcase', 'snake_case'],
  devtools: ['http request', 'api', 'dns', 'whois', 'domain', 'archive', 'zip', 'tar', 'compress', 'extract', 'health check'],
};
